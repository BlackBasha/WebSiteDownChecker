...
namespace Core.EventBus
{
        ...
        : IRabbitMQPersistentConnection
    {
        ...
        bool _disposed;
        private readonly bool IsLogQueue = false;
        object sync_root = new object();

        public DefaultRabbitMQPersistentConnection(bool isLogQueue)
        {
            IsLogQueue = isLogQueue;
        ...
        public List<Uri> RabbitMQConnectionStringList
        {
            get
            {
                ...
                if (IsLogQueue)
                {
                    ...
                    urlList.Add(new Uri("amqp://guest:guest@localhost:5672//"));
                }
                else
                {
                    urlList.Add(new Uri("amqp://guest:guest@localhost:5672//"));
        ...
        public bool TryConnect()
        {
            ...
            lock (sync_root)
            {
                ...
                policy.Execute(() =>
                {
                    ...
                    _connectionFactory.Uri = RabbitMQConnectionStringList.First();
